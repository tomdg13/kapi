...
exports.TrasactionModule = TrasactionModule = __decorate([
    (0, common_1.Module)({
        controllers: [transaction_controller_1.TrasactionController],
        providers: [transaction_service_1.TrasactionService],
    })
], TrasactionModule);
