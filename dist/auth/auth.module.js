...
const customer_entity_1 = require("./users/customer.entity");
const driver_entity_1 = require("./users/driver.entity");
const iousers_entity_1 = require("./users/iousers.entity");
...
exports.UserAuthModule = UserAuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([users_entity_1.User, customer_entity_1.Customer, driver_entity_1.Driver, iousers_entity_1.IOUser]),
        ],
